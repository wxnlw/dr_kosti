window.APP_CONFIG = {
  ...
  gift: {
    title: "Максим и Андрей дарят тебе подписку на Gemini Pro на год",
    ...
    link: "",
    login: "yijekurisum077@gmail.com",
    password: "p097531@",
  },
  ui: {
  ...
  game: {
    ...
    steps: [
      ...
      { id: "add-onion", type: "tray-to-pot", item: "onion", prompt: "Добавь нарезанный лук из нижнего лотка в казан.", successText: "Лук добавлен.", result: { potAdd: "onion" } },
      { id: "add-carrot", type: "tray-to-pot", item: "carrot", prompt: "Теперь добавь морковь.", successText: "Морковь добавлена.", result: { potAdd: "carrot" } },
      ...
      { id: "add-rice", type: "tray-to-pot", item: "rice", prompt: "Теперь засыпай подготовленный рис.", successText: "Рис в казане.", result: { potAdd: "rice" } },
      { id: "add-garlic", type: "tray-to-pot", item: "garlic", prompt: "Добавь чеснок из нижнего лотка.", successText: "Чеснок добавлен.", result: { potAdd: "garlic" } },
